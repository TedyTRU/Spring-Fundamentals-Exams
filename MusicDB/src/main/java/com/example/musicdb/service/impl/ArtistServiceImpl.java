...
public class ArtistServiceImpl implements ArtistService {
    ...
    public void initArtist() {
        ...
        List<Artist> artists = Arrays.stream(ArtistNameEnum.values())
                .map(artistNameEnum -> new Artist()
                        .setName(artistNameEnum)
                        .setCareerInformation(careerInfo(artistNameEnum)))
                .toList();
    ...
    private String careerInfo(ArtistNameEnum artistNameEnum) {
        return switch (artistNameEnum) {
    ...
    @Override
    public Artist findArtistByNameEnum(ArtistNameEnum artist) {
